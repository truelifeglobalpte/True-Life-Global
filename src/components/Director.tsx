...
const LEADERS = [
  {
    ...
    bio: [
      ...
      "He earned a B.B.A. and LL.B. (Hons) from Bharath Institute of Higher Education and Research in Chennai, and has received an Honorary Doctorate in Social Services. Additionally, he is currently pursuing an MBA in Human Resource Management at Alagappa University, Karaikudi.",
